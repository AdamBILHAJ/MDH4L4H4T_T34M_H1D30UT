...
if not DEBUG:
    ...
    SECURE_HSTS_SECONDS = 3600  # start low, raise to 31536000 once confirmed working
...
if MEDIA_BUCKET and MEDIA_ACCESS_KEY_ID and MEDIA_SECRET_ACCESS_KEY and MEDIA_ENDPOINT_URL:
    ...
    AWS_S3_REGION_NAME = os.environ.get('MEDIA_REGION', 'auto')
    AWS_QUERYSTRING_AUTH = True
    AWS_QUERYSTRING_EXPIRE = 3600
    MEDIA_URL = f'{MEDIA_ENDPOINT_URL}/{MEDIA_BUCKET}/'
else:
    MEDIA_URL = '/media/'
